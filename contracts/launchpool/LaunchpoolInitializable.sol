...
contract LaunchpoolInitializable is ReentrancyGuard, Ownable {
    ...
    function initialize(
        ...
        require(!isInitialized, "Launchpool: already initialized");
        require(msg.sender == factory, "Launchpool: not factory");
